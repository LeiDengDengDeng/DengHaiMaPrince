...
//		commodityBL=new Commodity(null);
	...
	public void paintComponent(Graphics g) {
		...
		g.drawImage(IMG_Connect.getImage(), 30+IMG_Circle.getIconWidth()/2-2,IMG_Search.getIconHeight()+searchToinfo+16+gap*i+IMG_Circle.getIconHeight()+4, null);
		g.drawImage(IMG_Line.getImage(), 30+IMG_Circle.getIconWidth()+8,IMG_Search.getIconHeight()+searchToinfo+16+IMG_Connect.getIconHeight()+IMG_Circle.getIconHeight()+gap*i , null);
		i=1;
		g.drawImage(IMG_Circle.getImage(),30, IMG_Search.getIconHeight()+searchToinfo+16+gap*i, null);
		g.drawImage(IMG_Connect.getImage(), 30+IMG_Circle.getIconWidth()/2-2,IMG_Search.getIconHeight()+searchToinfo+16+gap*i+IMG_Circle.getIconHeight()+4, null);
		g.drawImage(IMG_Line.getImage(), 30+IMG_Circle.getIconWidth()+8,IMG_Search.getIconHeight()+searchToinfo+16+IMG_Connect.getIconHeight()+IMG_Circle.getIconHeight()+gap*i , null);
