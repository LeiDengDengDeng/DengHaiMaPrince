...
public class KeeperAuthorityPanel extends JPanel{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8860256770864772227L;
	        ...
	        public MyButtonActionListener(KeeperAuthorityPanel container) {
		        ...
		        public void actionPerformed(ActionEvent e) {
		        	if(e.getSource() == confirmButton){
		        		...
		        		AuthorityVO authorityVO = new AuthorityVO("中转中心仓库管理员");
		        		authorityVO.setAuthority(authority);
		        		position.changeAuthority(authorityVO);
			        	staffManage.changeAuthority(authority, "中转中心仓库管理员");
