...
public class DriverData_Driver {
	...
	DriverPO dpo1 = new DriverPO("025000000", "叶良辰", 2015, 11, 5, 
			"321002000100010000", "88888888888", Sex.MALE, 2015);
	DriverPO dpo2 = new DriverPO("025000001", "赵日天", 2015, 11, 5, 
			"321002000100010000", "88888888888", Sex.MALE, 2015);
//	driverData.insert(dpo1);
//	driverData.insert(dpo2);
//	driverData.deleteDriverPO(025000001);
	System.out.println("size: " + driverData.findsDriverPO().size());
	System.out.println("营业厅： " + driverData.findsDriverPO("025000000").size());
